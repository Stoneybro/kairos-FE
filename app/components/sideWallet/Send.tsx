...
const Send = (balance: balanceType) => {
  /*//////////////////////////////////////////////////////////////*/
  //                               TYPES
  /*//////////////////////////////////////////////////////////////*/
  ...
  const { data, isSuccess } = useTransactionReceipt({ hash: useSendHash });
    ...
    <div className='p-4 flex flex-col w-full h-full gap-4 mt-12'>
      <div className='flex flex-col gap-2 w-full'>
        <div className='flex items-center justify-between'>
          <label htmlFor='Addressto' className='text-gray-400 text-sm'>
            Send to
          </label>
          <button
            className='text-xs text-gray-400 bg-main p-2 rounded-lg cursor-pointer'
      ...
      <button
        ...
        onClick={handlesend}
        className={`${
          isInvalid ? "bg-button-secondary cursor-pointer" : "bg-white"
